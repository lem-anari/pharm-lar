...
<div class="inner">
<header>
			<h1><a href="#all" ><button type="button" class="btn btn-primary btn-lg">Просмотреть всех представителей</button></a></h1>
			<h1><a href="#current" ><button type="button" class="btn btn-primary btn-lg" >Выполняющие аудит в данный момент</button></a></h1>
			<h1><a href="#uncare" ><button type="button" class="btn btn-primary btn-lg">Не выполняющие обязанностей</button></a></h1>
		...
		<header>
            ...
            @foreach ($employees as $employee)
			    <div class="row gtr-50 border">
					...
					<div class="col-8">
						<h4></h4>
                        <textarea type="text" value="">{{$employee->fullname}} - {{$employee->position}} - {{$employee->salaryrate}}
                        </textarea>
						<p class="text_color">
                        geolocation: {{$employee->geolocation}}<br>
						</p>
					</div>
				</div>
			@endforeach  
