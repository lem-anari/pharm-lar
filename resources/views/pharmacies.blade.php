...
<div class="inner">
<header>
			<h1><a href="#all" ><button type="button" class="btn btn-primary btn-lg">Просмотреть все аптеки</button></a></h1>
			<h1><a href="#supplies" ><button type="button" class="btn btn-primary btn-lg" >Заполнить поставки</button></a></h1>
		...
		<header>
            ...
            @foreach ($pharmacies as $pharmacy)
			    <div class="row gtr-50 border">
					...
					<div class="col-8">
						<h4></h4>
                        <textarea type="text" value="">{{$pharmacy->nameofpharm}} - {{$pharmacy->adressofpharm}} 
                        </textarea>
					</div>
				</div>
			@endforeach  
